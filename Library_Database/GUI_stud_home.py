...
from GUI_stud_login import user_log 
...
imglogo = Image.open("Images/cet.jpg")
...
imghead = Image.open("Images/head1.jpg")
#print logo_width,logo_height
...
imgbg = Image.open("Images/bg2.jpg")
#print logo_width,logo_height
...
originalid = Image.open('Images/barcodescan.jpg')
...
originalface = Image.open('Images/facerecog.jpg')
...
scanpass = Button(bottomframe, text='Scan pass', font=myFont, relief='raised',command=user_log, bg='bisque2')


originalpass = Image.open('Images/pass.jpg')
